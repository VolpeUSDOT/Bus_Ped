...
def make_map():
    ...
    routeb = arcpy.mapping.Layer(r'\\vntscex.local\DFS\3BC-Share$_Mobileye_Data\ArcMap\Standard Layers\Route_B.lyr')
    df = arcpy.mapping.ListDataFrames(mxd, "Layers")[0]
    arcpy.mapping.AddLayer(df,routeb)
    
    print("Add basemap")
    #Add Basemap. Will always be at the bottom of the layers list
    basemapLayer = arcpy.mapping.Layer(r'\\vntscex.local\DFS\3BC-Share$_Mobileye_Data\ArcMap\Standard Layers\Basemap.lyr')   
    ...
    sourceLayer = arcpy.mapping.Layer(r'\\vntscex.local\DFS\3BC-Share$_Mobileye_Data\ArcMap\Standard Layers\Standard_Raster.lyr')
