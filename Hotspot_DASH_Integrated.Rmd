...
ggmap(map_toner_13, extent  = "device") +
  geom_point(data = db.ll@data[sample(1:nrow(db@data), size = 10000),] %>% filter(route_name == "DASH B"), 
             aes(x = ll.lon, y = ll.lat, color = warning_name), size = 4, alpha = 0.5) +
